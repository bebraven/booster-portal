class FixBadProjectScores86Table < ActiveRecord::Migration
  tag :predeploy
  def change
    ...
    orig_column_names = [
      ...
      'Total Score -- Learning Lab Engagement - Empathize',
      ...
      'Total Score -- 5/28 Work Block Engagement - Capstone Challenge Presentations',
    ...
    drop_table :course86_project_scores
